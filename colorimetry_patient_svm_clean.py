...
# ## 15 min
    positive_train_15=import_fused('15','train','P')
    positive_test_15=import_fused('15','test','P') #for a test on entire test dataset   
    negative_train_15=import_fused('15','train','N')
    negative_test_15=import_fused('15','test','N')
...
if __name__ == "__main__":
    ...
    class_0_train=add_class_single(negative_train_15, num_class=0)
    class_1_train=add_class_single(positive_train_15, num_class=1) # the data is not shuffled yet
...
#%% Test aggregated
    ...
    class_0_test=add_class_single(negative_test_15, num_class=0)
    class_1_test=add_class_single(positive_test_15, num_class=1) #data not shuffled yet
...
#for lists of all the results
    all_P_test=data_indiv(timept='15',N_or_P='P')
    all_N_test=data_indiv(timept='15',N_or_P='N')
